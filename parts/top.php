...
<head>
	...
	<link rel="stylesheet" href="http://localhost:80/progressus/assets/css/bootstrap.min.css">
	<link rel="stylesheet" href="http://localhost:80/progressus/assets/css/font-awesome.min.css">
	<link rel="stylesheet" href="http://localhost:80/progressus/assets/css/bootstrap-theme.css" media="screen" >
	<link rel="stylesheet" href="http://localhost:80/progressus/assets/css/main.css">
        	<!-- JavaScript libs are placed at the end of the document so the pages load faster -->
	<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
	<script src="http://netdna.bootstrapcdn.com/bootstrap/3.0.0/js/bootstrap.min.js"></script>
	<script src="http://localhost:80/progressus/assets/js/headroom.min.js"></script>
	<script src="http://localhost:80/progressus/assets/js/jQuery.headroom.min.js"></script>
	<script src="http://localhost:80/progressus/assets/js/template.js"></script>     
